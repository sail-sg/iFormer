...
parser.add_argument('--K', default=1024, type=int,
    help="memory size 1536、2560、7680 1024")
...
def validate(args):
    ...
    # ========================
    args.mem_idx = [10]
    # args.mem_idx = list(range(1,13))
    # mem_idx = args.mem_idx
    # student_mem = vit_mem(args.embed_dim, mem_idx=args.mem_idx, K=args.K, top_n=args.knn, n_center=args.n_center)
    # student_mem = student_mem.cuda()
    # ========================
